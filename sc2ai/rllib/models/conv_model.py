...
class SC2ConvModel(Model):
    """Custom RLlib model which only use convolutional layers for both the policy and value function approximation.
    """

    def _build_layers_v2_old(self, input_dict, num_outputs, options):
